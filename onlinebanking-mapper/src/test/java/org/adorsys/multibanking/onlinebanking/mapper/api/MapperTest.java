                    ...
                    for (int param = 0; param < numberOfTemplateParams; param++) {
                        ...
                        if (type instanceof Class) {
                            ...
                            if (("" + type).contains("interface")) {
                                ...
                                LOGGER.info(4.6 + space + field.getName() + " " + type.getTypeName() + " ??? DONT KNOW WHAT TO DO");
                                LOGGER.info(4.7 + space + field.getName() + " " + type + " ??? DONT KNOW WHAT TO DO");
                                LOGGER.info(4.8 + space + field.getName() + " " + type.getClass() + " ??? DONT KNOW WHAT TO DO");
                                // Class<?> clazzy = Class.forName(type.getTypeName());
                              //  Class<?> clazzy = type.getClass();
                              //   printMembers(space, clazzy);
                            }
                        }
                    }
                } else {
